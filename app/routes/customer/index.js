...
router.get('/customers/one/:id', c(controllers.getCustomer, (req, res, next) => [req.params.id]));
router.get(
  '/customers/verify',
...
router.post(
  '/customers/register',
  c(controllers.registerCustomer, (req, res, next) => [req.body.email, req.body.password]),
);
router.post('/customers/login', c(controllers.loginCustomer));
router.post(
  '/customers/update/:id',
  c(controllers.updateCustomer, (req, res, next) => [req.params.id, req.body.params]),
);
router.post(
  '/customers/delete/:id',
